...
public class ServCapConScoringFlood 
{
	 static int occurenceinsittermfile;
		...
		public static void  calculatemultipleservicescoreflood()
		 ...
		 { 
			...
			// ArrayList<ServtermnameandWeight> FitbitVersa = new ArrayList<ServtermnameandWeight>();
			 ...
			 //https://www.iot-store.com.au/collections/sensors/products/dfrobot-gravity-analog-water-pressure-sensor
				 
			 	
			 ArrayList<ServtermnameandWeight> WaterPressureSensor = new ArrayList<ServtermnameandWeight>(); 
			 ...
			 */	 
		     ...
		     ServtermnameandWeight sw232 = new ServtermnameandWeight("water pressure",1.0);
		     ServtermnameandWeight sw233 = new ServtermnameandWeight("water",1.0);
		     ...
		     */
		      SituationTermshereWeights.add(1.0);
		      SituationTermshereWeights.add(0.214);
		      SituationTermshereWeights.add(0.272);
		    	 ...
		    	 try 
		    	  ...
		    	  // System.out.println(arraysizetokeepservicetermoccurence);
			       ...
			       //  System.out.println("Path = = "+ fpath.toAbsolutePath().toString());
			         ...
			         String wholefilecontents = new String(Files.readAllBytes(Paths.get("flood/"+ "stemmedsimplewtokens"+ " " + SituationTermshere.get(k) +".txt")));
			         //////////PREV CODE
			         /*
