...
public class ServCapConScoringCyclone 
{
	 static int occurenceinsittermfile;
		...
		public static void  calculatemultipleservicescorecyclone()
		 ...
		 { 
		     ...
		     */
		      SituationTermshereWeights.add(1.0);
		      SituationTermshereWeights.add(0.320);
		      SituationTermshereWeights.add(0.270);
		      SituationTermshereWeights.add(0.274);
		    	 ...
		    	 try 
		    	  ...
		    	  // System.out.println(arraysizetokeepservicetermoccurence);
			       ...
			       //  System.out.println("Path = = "+ fpath.toAbsolutePath().toString());
			         ...
			         String wholefilecontents = new String(Files.readAllBytes(Paths.get("cyclone/"+ "stemmedsimplewtokens"+ SituationTermshere.get(k) +".txt")));
			         //////////PREV CODE
			         /*
