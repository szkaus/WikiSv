...
public class WTextProcessorService 
{
	public static void  wtextprocess(String filename)	
	{
	    ...
	    "our","ours","ourselves","out","outside","over","overall","owing","own","page",
	     ...
	     "nil","a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q",
	     "r","s","t","u","v","w","x","y","z"};
		 ...
		 try{
				...
				FileOutputStream out=new FileOutputStream("servicefiles/"+"removedstopwords" + " "+ filename + ".txt");
