...
public class WikiforRequiredServices 
{
	
	public static void  wikiforrequiredservices(ArrayList<String> requiredunfoundserviceshere, Map<String, String> roottofullrequiredtermmap)	
		...
		*/  
		...
		// arraylistofservices.add(VICENV10LiqSSC);
		 ...
		 arraylistofservices.add(AUID1DysonAirPurifierS);
		   ...
		   for (k=0;k<requiredunfoundserviceshere.size();k++)   
			  {  
		    	String requiredterm= requiredunfoundserviceshere.get(k);
		    	System.out.println("$$$$$$$$$$$$$");
		    	...
		    	for(n=0;n<arraylistofservices.get(l).size();n++)
		    	{
		    	  ...
		    	  {  
		   	    ...
		   	    if(servicetermtomatch.replaceAll("\\s+","").equalsIgnoreCase(requiredterm.replaceAll("\\s+","")))
		   	    	 ...
		   	    	 {    		  
		   	          System.out.println("####The service given below is found among full samples");
		   	          System.out.println(requiredterm);
		   	          roottofullrequiredtermmap.remove(requiredterm);
		   	          requiredunfoundserviceshere.remove(k);
		   ...
		   RealwikiforRequiredservices.realwikiforrequiredservices(requiredunfoundserviceshere,roottofullrequiredtermmap);
		   System.out.println(Collections.singletonList(roottofullrequiredtermmap));
	}
